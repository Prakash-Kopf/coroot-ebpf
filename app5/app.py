...
resource = Resource.create({"service.name": "coroot-dualtrace-new"})
...
otlp_exporter = OTLPSpanExporter(
    endpoint="http://135.13.28.200:32598/v1/traces",
    headers={"x-api-key": "LnSnWdU392S3uTdQZWXLJDrOMLFYqhbr"},
